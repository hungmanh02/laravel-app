          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                    ...
                    <a href="{{ route('active-category-product',$item->id) }}"><i class="fa fa-thumbs-down fa-thumb-styling"></i></a>
                    @else
                    <a href="{{ route('unactive-category-product',$item->id) }}"><i class="fa fa-thumbs-up fa-thumb-styling"></i></a>
                    @endif
              <td>
